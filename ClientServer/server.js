...
var server = http.createServer( function ( request , response )
 { 
	...
	// Just the root, localtion of server.js. Will only enter here initally.
    if ( filePath == './' )
	{
	...
	{     
		// Returned from the callback, checking to see if valid.
        if ( exists ) 
		{
...
{
	console.log( "Connection from :"+ client.handshake.address.address );
...
function registerUser( client, userKeyParam )
{
	...
	usersModel.findOne( { userKey : userKeyParam } , function ( err, doc ) 
	{
		...
		console.log( "Here is the user data :" + map );
