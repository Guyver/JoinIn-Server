...
Scene_Builder.prototype.createMazeScene = function( level )
{
	this.destroyCurrentScene ();
	...
	// Load the walls
	this.createScene( level, image_loader.getAsset( 'seamlessWall.png' ) );
...
Scene_Builder.prototype.createSphere = function( position )
{
	var radius = 1000, segments = 100, rings = 100;
	var Material = new THREE.MeshLambertMaterial( {color: 0x00000000 });
